...
void cCube::render(float rotAngle)
{
	...
	glTexCoord2f(0.5, 0.33); glVertex3f(1, 1, 0);
	glTexCoord2f(0, 0.33); glVertex3f(1, 0, 0);
	//back
	glTexCoord2f(0, 0.33); glVertex3f(0, 0, 1);
	glTexCoord2f(0.5, 0.33); glVertex3f(0, 1, 1);
	glTexCoord2f(0.5, 0.66); glVertex3f(1, 1, 1);
	glTexCoord2f(0, 0.66); glVertex3f(1, 0, 1);

	//top
	glTexCoord2f(0, 0.66); glVertex3f(0, 1, 0);
	glTexCoord2f(0.5, 0.66); glVertex3f(0, 1, 1);
	glTexCoord2f(0.5, 1); glVertex3f(1, 1, 1);
	glTexCoord2f(0, 1); glVertex3f(1, 1, 0);
	//bottom
	glTexCoord2f(0.5, 0); glVertex3f(0, 0, 0);
	glTexCoord2f(1, 0); glVertex3f(0, 0, 1);
	glTexCoord2f(1, 0.33); glVertex3f(1, 0, 1);
	glTexCoord2f(0.5, 0.33); glVertex3f(1, 0, 0);

	//left
	glTexCoord2f(0.5, 0.33); glVertex3f(0, 0, 0);
	glTexCoord2f(1, 0.33); glVertex3f(0, 1, 0);
	glTexCoord2f(1, 0.66); glVertex3f(0, 1, 1);
	glTexCoord2f(0.5, 0.66); glVertex3f(0, 0, 1);
	//right
	glTexCoord2f(0.5, 0.66); glVertex3f(1, 0, 0);
	glTexCoord2f(1, 0.66); glVertex3f(1, 1, 0);
